        ...
        <section class="bgGrey py-4">
            <div class="containerFull">
                <div class="row">
                    ...
                    <div class="col-lg-5 ps-4 property_new_info">
                ...
                <section>
                    <div class="containerFull position-relative">
                        <div class="row">
                            ...
                            <div class="col-lg-8  info-tabs-content">
                                <div class="tab-content" id="myTabContent">
                                    ...
                                    <div class="tab-panel" id="floor-plans" aria-labelledby="floor-plans-tab">
                                        ...
                                        <div class="border mt-4 px-3 py-4 col-md-4  rounded">
                                            <h5>
                                    ...
                                    <div class="tab-panel" id="amenities" aria-labelledby="amenities-tab">
                                        ...
                                        <table class="mt-4 bordered-table">
                                            <thead>
                                                <tr>
                                                    <th>Key Amenities</th>
                                                    <th>Key Features</th>
