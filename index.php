         ...
         <div class="bannerContent ">
                              ...
                              <div class="dropdown-inner-box-content-options ">
                                 <div class="dropdown-inner-box-content-options">
                                    ...
                                    <input type="checkbox" id="shop-showroom" name="property-type"
                                       value="shop-showroom">
                                    <label for="shop-showroom">Shop/Showroom</label><input type="checkbox"
                                       id="warehouse-godown" name="property-type" value="warehouse-godown">
            ...
            <div class="formBanner home-page">
               <div class="formInline home-page">
                  <div id="residential" class="tab-content">
                     <div class="">
                        <div class="d-flex align-items-center lease-box">
                           <i class="fa-solid fa-house"></i>
                           <select id="residential-select" class="border-0">
                              <option value="buy">Buy</option>
                              <option value="rent">Rent</option>
                           </select>
                        </div>
                  ...
                  <div id="commercial" class="d-none tab-content">
                     <div class="">
                        <div class="d-flex align-items-center lease-box">
                           <i class="fa-solid fa-house"></i>
                           <select id="commercial-select" class="border-0">
                  ...
                  <div class="locationFeild ui-widget">
                     ...
                     <div class="newselect" id="dropdown1">
                        <div class="d-flex">
                           ...
                           <i class="fa fa-chevron-down pe-3 pt-1"></i>
                        ...
                        <div class="newoptions">
                           ...
                           <!-- <div>
                              ...
                              <label class="newoption" for="option-2" data-txt="Add Location"></label>
                           </div> -->
                           <div>
                              <input id="option-2" name="dropdown1" type="radio" />
                              <label class="newoption" for="option-2" data-txt="Sundar Nagar"></label>
                           </div>
                           <div>
                              <input id="option-3" name="dropdown1" type="radio" />
                              <label class="newoption" for="option-3" data-txt="Mindspace"></label>
                           </div>
                           <div>
                              <input id="option-4" name="dropdown1" type="radio" />
                              <label class="newoption" for="option-4" data-txt="Kachpada"></label>
                           </div>
                           <div>
                              <input id="option-5" name="dropdown1" type="radio" />
                              <label class="newoption" for="option-5" data-txt="Evershine Nagar"></label>
                           </div>
                        </div>
                     </div>
               ...
               <div class="property-type-dropdown">
                  <div class="dropdown-inner-box">
                     <div class="dropdown-inner-box-content">
                        <div class="residential-property">
                           <p class="title-dropdown residential_filter">Residential <i class="fa fa-chevron-down"></i>
                           </p>
                           <div class="residential_options">
                              <div class="dropdown-inner-box-content-options">
                        ...
                        <div class="commercial-property d-none">
                           <p class="title-dropdown commercial_filter">Commercial Properties <i
      ...
      <section>
         <div class="containerFull">
            <div class="d-flex justify-content-between align-items-center">
               <h4 class="heading fontHeading fontWeight600">Latest <span class="text_primary">Properties</span>
               </h4>
            ...
            <div class="box-new">
               ...
               <div class="popularSlider1 popularSlider">
            ...
            <div class="box-new activeBox">



               <div class="popularSlider2 popularSlider">
                  <div class="itemPopular">
                     <a href="#">
                        <div class="imgPopular">
                           <picture>
            ...
            <div class="box-new">
               ...
               <div class="popularSlider3 popularSlider">
                  <div class="itemPopular">
                     <a href="#">
                        <div class="imgPopular">
                           <picture>
